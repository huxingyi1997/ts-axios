...
ts-axios 是一个基于 promise 的 HTTP 库，可以用在浏览器和 node.js 中。
...
```bash
cnpm install ts-axios-hxy
```

或者直接使用npm命令

```bash
npm install ts-axios-hxy
```

**使用 git clone:**

国内用户推荐使用[gitee](https://gitee.com/hxy1997/ts-axios)

```bash
git clone git@gitee.com:hxy1997/ts-axios.git
```

或者直接使用[github](https://github.com/huxingyi1997/ts-axios)

```bash
git clone git@github.com:huxingyi1997/ts-axios.git
```
